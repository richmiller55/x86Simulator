#ifndef RISC_UI_MANAGER_H
#define RISC_UI_MANAGER_H
...
class RiscUIManager {
public:
    RiscUIManager(const Memory& memory_instance);
    ~RiscUIManager();

    void setRegisterMap(const RegisterMap* regs);
...
private:
    ...
    const RegisterMap* current_regs_;
